...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = (Integer p) ->{
    	String firstname = "first_"+p;
    	String lastname = "last_"+p;
    	Integer age = p;
    	String password = "pass_"+p;
    ...
    public void test_intToPerson() throws Exception {
    	...
    	int num = 10;
        Person result = intToPerson.apply(num);
